...
class TD3(object):
    ...
    def train(self, replay_buffer, iterations, batch_size=10, discount=0.99, tau=0.005, policy_noise=0.2,
...
if not os.path.exists("simglucose/controller/results"):
    os.makedirs("simglucose/controller/results")
if save_models and not os.path.exists("simglucose/controller/pytorch_models"):
    os.makedirs("simglucose/controller/pytorch_models")
